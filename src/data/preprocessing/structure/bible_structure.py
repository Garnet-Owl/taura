...
def get_missing_verses(parsed_verses: Dict[str, Dict[int, Dict[int, str]]], book_name: str) -> List[Tuple[int, int]]:
    """
...
def get_extra_verses(parsed_verses: Dict[str, Dict[int, Dict[int, str]]], book_name: str) -> List[Tuple[int, int]]:
    """
